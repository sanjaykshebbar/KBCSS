...
$profilePicPath = $facultyData['profilePicture'] ?? "../assets/placeholder.png";
...
function handleProfilePictureUpload($email, $userId, $facultyData, $conn) {
    $uploadDir = "./Profile-Pic/Admin/" . $email . "/";
...
<head>
    ...
    <style>
        ...
        /* Hover effect */
        button[name="updateAdminInfo"]:hover {
            background-color: #45a049; /* Slightly darker green on hover */
            transform: scale(1.05);     /* Slightly enlarge the button on hover */
        }

        /* Focus effect */
        button[name="updateAdminInfo"]:focus {
            outline: none;             /* Remove outline */
            box-shadow: 0 0 10px rgba(72, 245, 72, 0.7); /* Green glowing effect on focus */
        }

        /* Hidden button */
        button[name="updateAdminInfo"][style="display:none;"] {
    ...
    <h3 style="text-align: center;"><b>Manage Your Profile</b></h3>
        ...
        <form method="POST">
            ...
            <!-- Show the button if Employee ID or Specialization is empty -->
                <button type="submit" name="updateAdminInfo">Update Profile</button>
            <?php else: ?>
            <!-- Hide the button if both Employee ID and Specialization are filled -->
                <button type="submit" name="updateAdminInfo" style="display:none;">Update Profile</button>
            <?php endif; ?>
